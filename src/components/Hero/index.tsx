      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="lg:hidden flex flex-col items-center mb-8">
            ...
            {/* Mobile-only CTA Buttons — shown below the image */}
            <div className="flex flex-col gap-3 w-full mt-6">
              <a href="#contact" className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-full font-buttons text-base shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all text-white" style={{ background: 'linear-gradient(135deg, #7B3FA0, #A855F7)' }}>
                <Calendar size={20} />
                Book Your Consultation
              </a>
              <div className="flex gap-3">
                <a href="https://wa.me/919784249695" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5 rounded-full font-buttons text-base hover:-translate-y-1 transition-all group" style={{ background: 'rgba(255,255,255,0.07)', border: '1px solid rgba(255,255,255,0.12)', color: 'white' }}>
                  <img src="/whatsapp-logo.png" alt="WhatsApp" className="w-5 h-5 group-hover:scale-110 transition-transform" />
                  WhatsApp
                </a>
                <a href="https://www.instagram.com/tarot_aditya?igsh=MXRvNTE0dHdpZDRqaQ==" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5 rounded-full font-buttons text-base hover:-translate-y-1 transition-all group" style={{ background: 'rgba(255,255,255,0.07)', border: '1px solid rgba(255,255,255,0.12)', color: 'white' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:scale-110 transition-transform" style={{ stroke: 'url(#ig-grad-mobile)' }}>
                    <defs>
          ...
          <div className="hidden lg:flex flex-row flex-wrap gap-4">
